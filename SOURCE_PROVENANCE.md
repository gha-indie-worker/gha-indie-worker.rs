...
- Trusted Linux conformance executor: `src/linux_runner.rs` is pinned to Git blob `4d29f2c1d00367d84c72df9dfed2bc1dca99b3e2` and `src/bin/gha-linux-runner.rs` is pinned to Git blob `deca1126fe6bd8d03e4e3f105d2b635408a5175a`; host shell execution requires an explicit CLI capability and is not reachable from webhook or HTTP intake
