...
- Trusted Linux conformance executor: `src/linux_runner.rs` is pinned to Git blob `e4809c5c89c140348b1be4f3241f998c10e50908` and `src/bin/gha-linux-runner.rs` is pinned to Git blob `deca1126fe6bd8d03e4e3f105d2b635408a5175a`; host shell execution requires an explicit CLI capability and is not reachable from webhook or HTTP intake
