...
- Trusted Linux conformance executor: `src/linux_runner.rs` is pinned to Git blob `c9b61e9ccb959e5deff39dc890f1e3aae89c21c0` and `src/bin/gha-linux-runner.rs` is pinned to Git blob `deca1126fe6bd8d03e4e3f105d2b635408a5175a`; host shell execution requires an explicit CLI capability and is not reachable from webhook or HTTP intake
- Trusted Linux workflow scheduler: `src/workflow_runner.rs` is pinned to Git blob `44d4183d5ced7c210d9a8c1766ef9c3949a210ef` and `src/bin/gha-linux-workflow.rs` is pinned to Git blob `0c0ca9329b02d4aafb1d3c71609320c36fd15a67`; it preflights the complete plan, isolates concrete job workspaces, and schedules supported static matrices and dependencies without granting execution authority to intake
