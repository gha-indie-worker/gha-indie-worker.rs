...
- Trusted Linux conformance executor: `src/linux_runner.rs` is pinned to Git blob `2c75fda9d9eb52eb674ac8b5308c40ddea2569de` and `src/bin/gha-linux-runner.rs` is pinned to Git blob `deca1126fe6bd8d03e4e3f105d2b635408a5175a`; host shell execution requires an explicit CLI capability and is not reachable from webhook or HTTP intake
