...
Secrets for `gha-indie-worker/gha-indie-worker.rs` are **committed, encrypted**, with [sops] + [age],
...
```sh
just env-docker-run dev ghcr.io/gha-indie-worker/gha-indie-worker.rs:dev
